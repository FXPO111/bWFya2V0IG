...
import backend.logging_utils.memory_logger as memory_logger
...
# ── тута свечки ──────────────────────────────────────────
from backend.db.candle_db import init_db, insert_candle, load_candles, fill_incomplete_candle
from backend.core.models import Candle
# ── тута ликвидность ─────────────────────────────────────
from backend.db.liquidity_db import init_db as init_liquidity_db, load_liquidity_state, save_liquidity_state
# ───тута кластера ────────────────────────────────
from backend.db.trade_db import init_db as init_trdb, insert_batch as tr_insert_batch, load_trades as tr_load_trades
...
# ─────────────────────────────────
from backend.logging_utils.trade_logger import _flush as flush_trades
# ─────────────────────────────────


from backend.core.order import Order, OrderSide, OrderType
from backend.core.order_book import OrderBook
from backend.core.market_context import MarketContextAdvanced
from backend.agents.market_maker import AdvancedMarketMaker
from backend.agents.market_maker2 import AdvancedMarketMaker2
from backend.agents.retail_trader import RetailTrader
# from backend.agents.return_liquidity_agent import ReturnLiquidityAgent
# from backend.agents.strategist_agent import InstitutionalExecutor
from backend.agents.is_pressure_executor import ISPressureExecutor
# from backend.agents.macro_campaign_executor import MacroCampaignExecutor
from backend.agents.liquidity_seeker import LiquiditySeeker
# from backend.agents.anti_trend_hedger import AntiTrendHedger
from backend.agents.latency_arb import LatencyArb
from backend.agents.passive_depth_provider import PassiveDepthProvider
# from backend.agents.macro_reversal_fund import MacroReversalFund
# from backend.agents.flow_campaign_executor import FlowCampaignExecutor
from backend.agents.risk_parity_vol_control_fund import RiskParityVolControlFund
from backend.agents.band_wall_provider import AdaptiveBandWallProvider
from backend.agents.dealer_risk_transfer import DealerRiskTransfer
from backend.agents.customer_aggregator_flow import CustomerAggregatorFlow
from backend.agents.tier1_jpm import Tier1JPMBank
# from backend.agents.corporate_flow_twap import CorporateFlowTWAP
# from trend_impuls import ReversalAgent
from backend.agents.tier1_ubs import Tier1UBSBank
from backend.agents.corporate_flow_manager import CorporateFlowManager
from backend.agents.breakout_agent import BreakoutTrader
from backend.agents.reversion_brain import ReversionBrain
# from backend.agents.fund_disruptor import RegimeShockDisruptor
# from trend_agent import TrendAgent
from backend.agents.multi_hour_metaorder_agent import MultiHourMetaOrderAgent
from backend.variants.agent_variants import build_variant_agents
from backend.variants.agent_variants2 import build_variant_agents2
